  ...
  main(void)
{
  ...
  printkg("-----------------------------------------------------------------------\n");
  printkg("Ignasi Juez Guirao i Albert Vidal Gonzalez - Subgrup 12\n");
  printkg("Optional implementations (2/2): Printc with colors, Scroll\n");
  printkg("Extra implementations: Delete, Space and Enter\n");
  printkg("-----------------------------------------------------------------------\n");
