...
/*
  ...
  el que se usa en alloc_frame
  si el contenido de esta entrada es == 0 la pagina esta libre, sino esta utilizada

  usar numero de referencias en vez de used o free
    ++phis_mem[x] vcuando hay nuevas referencias 
    --phys_mem[x] cuando se quita ref

    si es phismem[x] == 0 significa que esta libre
