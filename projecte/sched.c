...
struct buff_circular buffer_circular;
...
void init_buffer_circular(){
  buffer_circular.escritura=0;
  buffer_circular.lectura=0;
  buffer_circular.items=0;
}
